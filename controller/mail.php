...
function smtp_mail($to, $subject, $message, $from_name, $from, $cc, $bcc, $debug = false)
{
    ...
    $mail->ClearBCCs();
    $mail->SMTPAuth         = true;
    $mail->Host             = 'sinar-gemilang.tugasakhir.my.id;103.131.51.14';
    $mail->Port             = 587;
    $mail->SMTPSecure       = 'tls';
    $mail->Username         = 'no-reply@sinar-gemilang.tugasakhir.my.id';
    $mail->Password         = 'Itha040700_';
    $default_email_from     = 'no-reply@sinar-gemilang.tugasakhir.my.id';
    $default_email_from_name = 'Sinar Gemilang';
